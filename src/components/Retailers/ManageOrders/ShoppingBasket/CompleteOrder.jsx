...
import { createNewDistributorsGoodsRequest } from "../../../../api/distributerGoodsRequestsAPI";
...
function CompleteOrder() {
  ...
  const handlePaymentSuccess = async (data, details) => {
    ...
    const requestData = {
      distributorId: basket.sellerId,
      distributorName: basket.sellerName,
      retailerName: basket.buyerName,
      goodsForRetailers: itemsForRequest,
    ...
    if (!requestData.arrivalAddress) {
      ...
      try {
        // Call createNewDistributorsGoodsRequest with the requestData
        const response = await createNewDistributorsGoodsRequest(requestData);
        if (response.data) {
