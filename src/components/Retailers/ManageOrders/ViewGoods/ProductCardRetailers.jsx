...
const ProductCardRetailers = ({ d }) => {
  ...
  const handleAddToBasket = async (fromModal = false) => {
    ...
    const response = await addItemToBasket({
      ...
      sellerId: d.distributorId._id,
      sellerName: d.distributorId.full_name,
    });
  ...
  return (
    <div className="productCard-raw">
      ...
      <div className="details-raw">
        ...
        <p className="by-text">
          By <span>{d?.distributorId?.full_name}</span>
        </p>
        <div className="price">
          <p>{d.price} SAR</p>
          <button
...
export default ProductCardRetailers;
