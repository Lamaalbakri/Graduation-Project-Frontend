        ...
        <div className='shoppingCart'>
            <Breadcrumb
                crumbs={[
                    ...
                    { name: "Checkout confirmation", path: `/shoppingCart/${id}/complete` }
                ]}
            />
            <div className='complate-page-container'>
                ...
                <div className='user-info'>
                    <div className='user-info-step'>
                        <div className='step-num'><p>1</p></div>
                        <div className='step-content'>
                            ...
                            <div className='adress-detail'>
                                ...
                                <div className='edit-address'>
                                    <button onClick={handleEditAddress}>Edit <EditOutlined /></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className='user-info-step'>
                        <div className='step-num'><p>2</p></div>
                        <div className='step-content'>
                            ...
                            <div className='step-detail'>
                                ...
                                <div className='card-form'>
                                    <label className='card-num'>Card Number
                                        <input type="text" placeholder='Card Number' required />
                                    </label>
                                    <label className='card-date'>Expiration Date
                                        <input type="date" placeholder='Expiration Date' required />
                                    </label>
                                    <label className='card-code'>CVV Code
                                        <input type="text" placeholder='CVV' required />
                                    </label>
                                </div>
                                <div className='pay-button-container'>
                                    <button className='Checkout-button' onClick={handelCheckout}>Checkout Confirmation</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {dialogState.confirmationDialog && (
                <ConfirmationDialog
                    title={`${stepType === "confirmPay" ? "Are you ready to confirm your payment?" : "Your Order Has Been Created"}`}
                    message={` ${stepType === "confirmPay" ? "Once confirmed, you won't be able to cancel your order." : "Do You Want To View The Request? "}`}
