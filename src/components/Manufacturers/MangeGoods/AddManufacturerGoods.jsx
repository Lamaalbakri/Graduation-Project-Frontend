...
import {
  createGoods,
  uploadGoodsImage,
} from "../../../api/manageManufacturerGoodsAPI";

const AddManufacturerGoods = () => {
  ...
  const confirmRedirect = () => {
    navigate(`/viewManufacturerGoods/${userId}`);
...
export default AddManufacturerGoods;
